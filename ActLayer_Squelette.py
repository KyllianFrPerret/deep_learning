...
class ActLayer:
    ...
    def __init__(self,nbInput):
        ...
        self.output =[0 for x in range(nbInput)]
    ...
    def forward_propagation(self,input):
        ...
        for entree in range(len(self.output)):
            # Fonction tanh
            self.output[entree]=tanh(self.input[entree])
    ...
    def backward_propagation(self, output_error, learning_rate):
        ...
        """
        input_error = []
        # dE/dX = E(vecteur) *f'(X) (vecteur des dérivée)(multiplication terme à terme)
